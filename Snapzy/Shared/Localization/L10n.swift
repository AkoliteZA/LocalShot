...
enum L10n {
  ...
  enum PreferencesAdvanced {
    ...
    static let configSyncQueuedDescription = string(
      ...
      defaultValue: "Sync queued. LocalShot will update config.toml shortly.",
    ...
    static let configAccessWarningTitle = string(
      ...
      comment: "Warning title when LocalShot has not been granted config folder access"
    )
    static func configAccessWarningDescription(_ path: String) -> String {
      format(
        "preferences-advanced.config-access-warning-description",
        defaultValue: "Grant access to %@ once so LocalShot can create config.toml and apply direct edits on launch.",
    ...
    static let configSyncing = string(
      ...
      comment: "Toast shown while LocalShot syncs current settings into config.toml"
    )
    static let configSynced = string(
      "preferences-advanced.config-synced",
      defaultValue: "config.toml synced.",
      comment: "Toast shown after LocalShot syncs current settings into config.toml"
    )
    static let configSyncNeedsConfirmation = string(
      ...
      comment: "Toast shown when LocalShot needs confirmation before replacing externally changed config.toml"
    )
    ...
    static let configSyncConfirmationMessage = string(
      ...
      defaultValue: "config.toml no longer matches LocalShot settings and may have edits from outside the app. Syncing will replace it with current settings.",
    ...
    static func configDirectoryPanelMessage(_ path: String) -> String {
      format(
        ...
        defaultValue: "Grant access for %@. If the folder is missing, LocalShot will create it automatically.",
    ...
    static func configDirectoryPanelOnboardingMessage(_ path: String) -> String {
      format(
        ...
        defaultValue: "Grant access for %@. LocalShot will create config.toml there if it is missing.",
    ...
    static func configDirectoryMismatch(_ path: String) -> String {
      format(
        ...
        defaultValue: "Choose %@ to keep LocalShot config in the default dotfiles location.",
    ...
    static let restoreDefaultsConfirmationMessage = string(
      ...
      defaultValue: "If you confirm, LocalShot will replace config.toml with default values, reset app settings, and clear cloud credentials. Saved captures are not deleted.",
  ...
  enum Splash {
    static let welcomeTitle = string(
      ...
      defaultValue: "Welcome to LocalShot",
  ...
  enum Onboarding {
    ...
    static let shortcutsSubtitle = string(
      ...
      defaultValue: "Assign system shortcuts to LocalShot for quick access.",
    ...
    static let resolveShortcutOverlap = string(
      ...
      comment: "Warning title when system screenshot shortcuts overlap with LocalShot shortcuts"
    )
    static let openSettings = string(
    ...
    static let guideStep3 = string(
      ...
      defaultValue: "Uncheck the macOS screenshot shortcuts that overlap with the LocalShot shortcuts you want to keep on",
    ...
    static let diagnosticsDescription = string(
      ...
      defaultValue: "LocalShot can collect anonymous diagnostic logs when something goes wrong. These logs help us find and fix bugs faster.",
    ...
    static let completionDescription = string(
      ...
      defaultValue: "LocalShot is ready. Access it from the menu bar or use your keyboard shortcuts.",
  ...
  enum PreferencesGeneral {
    ...
    static let startAtLoginDescription = string(
      ...
      defaultValue: "Launch LocalShot when you log in",
    ...
    static let languageDescription = string(
      ...
      defaultValue: "Choose the language used across LocalShot",
      comment: "General preferences setting description"
    )
    ...
    static let languageRelaunchConfirmationTitle = string(
      ...
      defaultValue: "Relaunch LocalShot?",
    ...
    static let languageRelaunchConfirmationMessage = string(
      ...
      defaultValue: "LocalShot needs to quit and reopen to apply this language change everywhere.",
    ...
    static let languageRelaunchErrorTitle = string(
      ...
      defaultValue: "Could Not Relaunch LocalShot",
    ...
    static let saveLocationDescription = string(
      ...
      defaultValue: "Where LocalShot stores captures",
      comment: "General preferences setting description"
    )
    ...
    static let chooseSaveLocationMessage = string(
      ...
      defaultValue: "Choose where LocalShot saves captures",
  ...
  enum PreferencesCapture {
    ...
    static let includeInScreenshotsDescription = string(
      ...
      defaultValue: "Show LocalShot windows such as Annotate in captured images",
    ...
    static let includeInRecordingsDescription = string(
      ...
      defaultValue: "Show LocalShot windows such as Annotate in recorded videos",
      comment: "Capture preferences setting description"
    )
    ...
    static let jpegCutoutNote = string(
      ...
      defaultValue: "Object cutout captures require transparency. LocalShot will save them as PNG even when JPEG is selected.",
  ...
  enum PreferencesAnnotate {
    ...
    static let bringForwardAfterDragDescription = string(
      ...
      defaultValue: "When the editor stays open, bring LocalShot to the front and focus Annotate after the drop completes",
  ...
  enum PreferencesShortcuts {
    ...
    static let systemConflictTitle = string(
      ...
      defaultValue: "macOS screenshot shortcuts overlap with LocalShot",
    ...
    static let systemConflictDescription = string(
      ...
      defaultValue: "Turn off the overlapping macOS shortcuts to avoid conflicts with the LocalShot shortcuts you keep enabled.",
    ...
    static let disableShortcutsMessage = string(
      ...
      defaultValue: "You won't be able to capture screenshots or recordings using keyboard shortcuts from any app. You'll need to open LocalShot manually to use capture features.",
  ...
  enum Microphone {
    ...
    static let preferencesMessage = string(
      ...
      defaultValue: "LocalShot needs microphone permission. Please enable it in System Settings > Privacy & Security > Microphone.",
    ...
    static let recordingMessage = string(
      ...
      defaultValue: "LocalShot needs microphone permission to record audio. Please grant access in System Settings.",
  ...
  enum CloudTransfer {
    ...
    static let exportDescription = string(
      ...
      defaultValue: "Create an encrypted archive you can import on another Mac. LocalShot does not store this archive passphrase.",
    ...
    static let savePanelMessage = string(
      ...
      defaultValue: "Choose where LocalShot should save the encrypted credential archive.",
    ...
    static let chooserMessage = string(
      ...
      defaultValue: "Choose a LocalShot encrypted credential archive.",
    ...
    static let invalidArchive = string(
      ...
      defaultValue: "The selected file is not a valid LocalShot cloud credential archive.",
  ...
  enum CloudSettings {
    ...
    static let importCredentialsMessage = string(
      ...
      defaultValue: "LocalShot will load the imported values into the editor. Your current saved configuration stays unchanged until you click Save & Test.",
    ...
    static let importEncryptedArchiveDescription = string(
      ...
      defaultValue: "Load a previously exported LocalShot cloud archive to prefill this form.",
  ...
  enum AnnotateUI {
    ...
    static let saveFailedMessage = string(
      ...
      defaultValue: "LocalShot couldn't write to the selected location. Please choose another folder.",
  ...
  enum VideoEditor {
    ...
    static let followMouseOnlyWorksWithSnapzy = string(
      "video-editor.follow-mouse-only-works-with-localshot",
      defaultValue: "Follow Mouse only works with videos recorded by LocalShot after mouse tracking was added.",
    ...
    static func cannotReplaceOriginalMessage(_ details: String) -> String {
      format(
        ...
        defaultValue: "LocalShot doesn't have write access to this file location. Save as a copy instead.\n\n%@",
  ...
  enum ScrollingCapture {
    ...
    static let previewShowingLatestWhileLockingNewerContent = string(
      ...
      defaultValue: "Showing the latest stitched result while LocalShot locks newer content.",
    ...
    static let previewPausedScrollSlowly = string(
      ...
      defaultValue: "Preview paused - scroll slowly so LocalShot can re-align.",
    ...
    static let guidanceSnapzyLockingFirstFrame = string(
      "scrolling-capture.guidance-localshot-locking-first-frame",
      defaultValue: "LocalShot is locking the first frame",
    ...
    static let guidanceKeepOneDirectionSoSnapzyCanRealign = string(
      "scrolling-capture.guidance-keep-one-direction-so-localshot-can-realign",
      defaultValue: "Keep one direction so LocalShot can re-align",
    ...
    static let guidanceSnapzySealingStitchedResult = string(
      "scrolling-capture.guidance-localshot-sealing-stitched-result",
      defaultValue: "LocalShot is sealing the stitched result",
    ...
    static let captionLivePreviewRunning = string(
      ...
      defaultValue: "Live preview running while LocalShot locks the stitched frame.",
  ...
  enum Recording {
    ...
    static let saveLocationAccessRequiredMessage = string(
      ...
      defaultValue: "LocalShot needs a save folder permission to continue. Please choose a folder in onboarding or grant it now.",
      comment: "Alert message shown when save location access is missing"
    )
    static let chooseSaveLocationMessage = string(
      "recording.choose-save-location-message",
      defaultValue: "Choose where LocalShot should save screenshots and recordings",
  ...
  enum FileAccess {
    nonisolated static let chooseCapturesFolderMessage = string(
      ...
      defaultValue: "Choose where LocalShot should save screenshots and recordings",
      comment: "Open panel message shown when LocalShot asks the user to grant access to a save folder"
    )
    nonisolated static let grantAccessPrompt = string(
      "file-access.grant-access-prompt",
      defaultValue: "Grant Access",
      comment: "Open panel prompt shown when LocalShot asks the user to grant folder access"
    )
    nonisolated static let chooseFolderPrompt = string(
      "file-access.choose-folder-prompt",
      defaultValue: "Choose Folder",
      comment: "Open panel prompt shown when LocalShot asks the user to choose a folder"
    )
    nonisolated static let desktopPicturesAccessMessage = string(
      ...
      comment: "Open panel message shown when LocalShot asks for access to the system Desktop Pictures folder"
    )
    ...
    static let bookmarkSaveFailedMessage = string(
      ...
      defaultValue: "LocalShot could not persist access to this folder. Please choose the folder again and confirm permission.",
  ...
  enum ScreenCapture {
    ...
    nonisolated static let saveLocationPermissionRequired = string(
      ...
      comment: "Error shown when LocalShot cannot save a screenshot because folder access has not been granted"
    )
    nonisolated static let unableToCaptureSelectedArea = string(
      ...
      comment: "Error shown when LocalShot cannot capture the selected screenshot area"
    )
    nonisolated static let failedToCropCapturedImage = string(
      ...
      comment: "Error shown when LocalShot captures an image but fails to crop it to the selected area"
    )
    nonisolated static func couldNotCreateDirectory(_ message: String) -> String {
      format(
        ...
        comment: "Error shown when LocalShot cannot create the selected save folder. %@ is the underlying filesystem error.",
        message
      )
    }
    nonisolated static let webpEncodingFailed = string(
      ...
      comment: "Error shown when LocalShot cannot encode a screenshot as WebP"
    )
    nonisolated static let couldNotCreateImageDestination = string(
      ...
      comment: "Error shown when LocalShot cannot create an image writer for the screenshot"
    )
    nonisolated static let failedToWriteImageToDisk = string(
      ...
      comment: "Error shown when LocalShot fails while writing a screenshot to disk"
    )
    nonisolated static func fileWriteVerificationFailed(_ fileName: String) -> String {
      format(
        ...
        comment: "Error shown when LocalShot writes a screenshot file but cannot verify it afterward. %@ is the file name.",
        fileName
      )
    }
    ...
    nonisolated static let failedToCreateImageFromFrame = string(
      ...
      comment: "Error shown when LocalShot cannot convert a captured stream frame into an image"
    )
  ...
  enum OCR {
    ...
    static let qrTextOnlyUnsupported = string(
      ...
      defaultValue: "QR code detected, but LocalShot can only copy text-based QR content.",
  ...
  enum ScrollingCaptureStatus {
    ...
    static let noSavableResultReady = string(
      ...
      defaultValue: "LocalShot couldn't lock a savable stitched image yet. You can keep capturing, try Done again, or Cancel.",
    ...
    static let autoScrollNeedsAccessibility = string(
      ...
      defaultValue: "Auto Scroll needs Accessibility permission. Enable LocalShot in System Settings > Privacy & Security > Accessibility.",
    ...
    static let mixedDirectionsDetected = string(
      ...
      defaultValue: "Mixed scroll directions detected. Keep one direction so LocalShot can align.",
    ...
    static let couldntCaptureLastFrame = string(
      ...
      defaultValue: "Couldn't capture the last frame. LocalShot will save the current stitched result.",
    ...
    static let couldntRefreshLastFrame = string(
      ...
      defaultValue: "Couldn't refresh the last frame. LocalShot will save the current stitched result.",
    ...
    static let alignmentPaused = string(
      ...
      defaultValue: "Alignment paused. Slow down and keep one direction so LocalShot can recover.",
    ...
    static let finalizingCurrentCapture = string(
      ...
      defaultValue: "Finalizing the current capture. LocalShot is locking the latest stitched result before saving.",
    ...
    static func finalizingFrames(_ count: Int) -> String {
      format(
        ...
        defaultValue: "Locking the current capture. LocalShot is sealing %d stitched frames before saving.",
    ...
    static let finalizingNoNewContent = string(
      ...
      defaultValue: "No new content was detected. LocalShot is saving the current stitched result.",
    ...
    static let finalizingCouldntAlignLastFrame = string(
      ...
      defaultValue: "Couldn't align the last frame cleanly. LocalShot will save the current stitched result.",
    ...
    static let finalizingHeightLimitReached = string(
      ...
      defaultValue: "Height limit reached. LocalShot is saving the current stitched result.",
  ...
  enum PreferencesHistory {
    ...
    static let clearHistoryAlertMessage = string(
      ...
      defaultValue: "This will move all capture files to Trash and remove them from History. This action cannot be undone in LocalShot.",
